...
const Services = () => {
    ...
    return (
        <div>
            <Head>
                <title>Services | InnoVex Technologies Pvt. Ltd.</title>
            </Head>
                ...
                <div className="container">
                    <div className="grid items-center gap-5 md:gap-10 lg:grid-cols-2">
                        ...
                        <div className="grid gap-4 rounded-[32px] sm:grid-cols-2 sm:gap-0">
                            <div
                                className="flex h-[200px] gap-4 px-4 py-7 text-white ltr:rounded-tl-[32px] rtl:rounded-tr-[32px]"
                            ...
                            <div
                                className="flex h-[200px] gap-4 px-4 py-7 text-white ltr:rounded-tr-[32px] rtl:rounded-tl-[32px]"
                                style={{ background: 'linear-gradient(130.61deg, #FFBD11 0%, #FF8E00 100%)' }}
                                data-aos="fade-up"
                                data-aos-duration="1000"
                            >
                            ...
                            <div
                                className="flex h-[200px] gap-4 px-4 py-7 text-white ltr:rounded-tl-[32px] rtl:rounded-tr-[32px] ltr:sm:rounded-bl-[32px] ltr:sm:rounded-tl-none rtl:sm:rounded-br-[32px] rtl:sm:rounded-tr-none"
                            ...
                            <div
                                className="flex h-[200px] gap-4 px-4 py-7 text-white ltr:rounded-tr-[32px] rtl:rounded-tl-[32px] ltr:sm:rounded-br-[32px] ltr:sm:rounded-tr-none rtl:sm:rounded-bl-[32px] rtl:sm:rounded-tl-none"
            ...
            <section className="bg-white/50 py-14 dark:bg-transparent lg:py-[100px]">
                <div className="container">
                    ...
                    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-6 md:grid-cols-4 lg:grid-cols-6">
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#DF2E31] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-black hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#3FB984] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#4F5B93] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="70"
                                    height="60"
                                    viewBox="0 0 70 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#FF291A] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#00749A] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#6C6C6C] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#41D0FD] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#E54C21] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#01D8FF] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <div className="group flex items-center justify-center rounded-[32px] bg-gray/10 px-[50px] py-[50px] transition duration-500 hover:scale-105 hover:bg-[#96BF49] hover:drop-shadow-[0_5px_13px_rgba(60,72,88,0.20)]">
                                <svg
                                    width="60"
                                    height="60"
                                    viewBox="0 0 60 60"
                        ...
                        <form action="" className="relative z-[1] text-center lg:pt-[50px]">
                            <div className="relative inline-block w-full sm:w-auto">
                                <input
                                    ...
                                    className="w-full rounded-3xl py-4 font-bold leading-5 outline-none ltr:pl-4 ltr:pr-[110px] rtl:pl-[110px] rtl:pr-4 dark:bg-gray-dark sm:w-[540px] sm:py-6 ltr:sm:pl-[30px] ltr:sm:pr-[140px] rtl:sm:pl-[140px] rtl:sm:pr-[30px]"
                                />
                                <button
                                    type="submit"
