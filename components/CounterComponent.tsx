        ...
        <div className="container">
            ...
            <div className="grid gap-[30px] sm:grid-cols-2 lg:grid-cols-4">
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white px-6 py-8 transition duration-500 hover:border-secondary hover:bg-secondary/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-secondary">
                        <div>
                            <svg
                                width="26"
                                height="26"
